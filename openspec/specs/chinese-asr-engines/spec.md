# chinese-asr-engines Specification

## Purpose
Chinese-family FluidAudio engines — Paraformer and SenseVoice conformers with text-only single-segment semantics (#50).
